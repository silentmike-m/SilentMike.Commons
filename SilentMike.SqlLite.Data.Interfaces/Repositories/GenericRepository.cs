...
using SilentMike.SqlLite.Data.Interfaces.Services;
using System.Collections.Generic;
using System.Linq;
using System.Reflection;

namespace SilentMike.SqlLite.Data.Interfaces.Repositories
{
    public class GenericRepository<T> : ReadOnlyRepository<T>, IGenericRepository<T>
        where T : TrackedEntity, new()
    {
        public GenericRepository(AbstractDbContext dbContext) : base(dbContext) { }
